...
# ===========================================================================
HOST = "RahulTripathi"   # shown as  RahulTripathi@github  in the header

ROWS = [
    ("host",),
    ("kv", "Role", "Principal Cloud & Systems Architect"),
    ("kv", "Company", "Amadeus Labs"),
    ("kv", "Core Focus", "End-to-End Distributed Systems (HLD → LLD)"),
    ("kv", "Exp", "12+ Years Enterprise Cloud Architecture"),
    ("gap",),
    ("sec", "Architecture & Design"),
    ("kv", "High-Level", "Ref Architectures, Boundaries, VNet Topologies, Failure Modes"),
    ("kv", "Low-Level", "Component Specs, Contracts, Data Flows, Identity Models"),
    ("kv", "Systems", "Cloud-Native Web Apps, Azure Functions, Microservices on ACR"),
    ("kv", "Data Layer", "Cosmos DB, Relational Stores, Azure AI Search"),
    ("gap",),
    ("sec", "Infrastructure & Governance"),
    ("kv", "Infra & IaC", "Terraform, Bicep, Enterprise Landing Zones"),
    ("kv", "Security", "Zero Trust Perimeters, Entra ID, Network Isolation"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Unified web apps, serverless & container microservices into coherent arch"),
    ("bul", "Designed enterprise landing zones with Zero Trust blast radius containment"),
    ("bul", "Architected secure multi-tenant AI platforms on Azure AI Foundry"),
]
